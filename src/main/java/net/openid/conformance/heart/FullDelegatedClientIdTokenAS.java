...
import net.openid.conformance.condition.client.ValidateIdTokenHeartClaims;
...
import net.openid.conformance.condition.client.VerifyIdTokenExpHeart;
...
public class FullDelegatedClientIdTokenAS extends AbstractRedirectServerTestModule {
	...
	private void handleAuthorizationResult() {
		...
		callAndContinueOnFailure(ValidateIdTokenSignature.class, Condition.ConditionResult.FAILURE, "HEART-OIDC-3.1");

		// This condition is a warning because we're not yet 100% sure of the code
		callAndContinueOnFailure(ValidateIdTokenSignatureUsingKid.class, Condition.ConditionResult.WARNING, "HEART-OIDC-3.1");

		//callAndStopOnFailure(ValidateIdToken.class);
		callAndContinueOnFailure(ValidateIdTokenHeartClaims.class, Condition.ConditionResult.FAILURE, "HEART-OIDC-3.1");

		callAndContinueOnFailure(VerifyIdTokenExpHeart.class, Condition.ConditionResult.WARNING, "HEART-OIDC-3.1");

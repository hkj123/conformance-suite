...
public class ExtractAssertionFromIntrospectionRequest extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		String assertion = env.getString("introspection_request", "body_form_params.client_assertion");
		String assertionType = env.getString("introspection_request", "body_form_params.client_assertion_type");

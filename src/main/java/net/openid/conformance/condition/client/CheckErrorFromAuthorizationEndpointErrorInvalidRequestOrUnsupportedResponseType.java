...
public class CheckErrorFromAuthorizationEndpointErrorInvalidRequestOrUnsupportedResponseType extends AbstractCondition {

	private static final List<String> EXPECTED_VALUES = ImmutableList.of("unsupported_response_type", "invalid_request");

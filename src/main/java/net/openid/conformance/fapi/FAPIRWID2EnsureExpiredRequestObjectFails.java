...
@PublishTestModule(
	testName = "fapi-rw-id2-ensure-expired-request-object-fails",
	displayName = "FAPI-RW-ID2: ensure expired request object fails",
...
public class FAPIRWID2EnsureExpiredRequestObjectFails extends AbstractFAPIRWID2ExpectingAuthorizationEndpointPlaceholderOrCallback {

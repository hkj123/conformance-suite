...
public class EnsureImplicitGrantTypeInClient_UnitTest {
	...
	private EnsureImplicitGrantTypeInClient cond;
	...
	/**
	 * Test method for {@link EnsureImplicitGrantTypeInClient#evaluate(Environment)}.
	 */
	@Test
